...
const EmailTemplateEditor: React.FC = () => {
  ...
  return (
    <div className="p-4  rounded-md mt-4">
      <h2 className="text-xl font-bold mb-4 text-center">Email Template Editor</h2>
      <div className="flex flex-col md:flex-row ">
        <div className="md:w-1/2 md:pr-2 justify-center items-center text-center">
          <h3 className="font-semibold text-left">HTML</h3>
          <textarea
